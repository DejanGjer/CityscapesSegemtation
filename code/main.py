...
if __name__ == "__main__":
    ...
    num_labels = len(label2id) - 1 # we subtract one because we ignore -1 label
    model = AutoModelForSemanticSegmentation.from_pretrained(config.checkpoint, id2label=id2label, label2id=label2id)
